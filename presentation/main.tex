...
\begin{frame}{Topic Modeling - LDA}
	...
	\end{exampleblock}
		...
		\begin{itemize}
            ...
            \item $\mathcal{P}(w | t)$ : la probabilité que le thème $t$ soit assigné au mot $w$
            \end{itemize}
	\end{block}}
...
\begin{frame}{Résultat Web Scraping}
    \begin{figure}[!h]
    \centering
    \includegraphics[scale=0.42]{df_scrap.png}
...
\begin{frame}{Résultat Topic Modeling}
    \begin{figure}[!h]
    \centering
    \includegraphics[scale=0.22]{pyLDAvis.png}
    \end{figure}
\end{frame}
...
\begin{frame}{Matrice de confusion}
    \begin{figure}[!h]
    \centering
    \includegraphics[scale=0.4]{conf.png}
    \end{figure}
\end{frame}
...
\begin{frame}{Résultat Dashboard}
    \begin{figure}[!h]
    \centering
    \includegraphics[scale=0.3]{Dash 1.png}
    \end{figure}
\end{frame}
